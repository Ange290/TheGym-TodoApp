    ...
    return (
        <div className="flex justify-center items-center">
            <div className="relative w-96">
                <input type="text" placeholder="Add todo..." className="w-full p-3 pr-12 border-gray-700 shadow-xl rounded-full focus:outline-none focus:ring-2 focus:ring-teal-500" />
                <button className="absolute right-3 top-1/2 transform -translate-y-1/2 text-teal-500 hover:text-teal-600">
